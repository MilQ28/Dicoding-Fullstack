...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      // [Basic] simpan data catatan awal
  ...
  render() {
    ...
    // [Advanced] pisahkan catatan aktif dan arsip, urutkan terbaru
    ...
    return (
      <div className="note-app" data-testid="note-app">
        <div className="note-app__header" data-testid="note-app-header">
          <h1>Notes</h1>
          <marquee className='copyright'>&copy; Syamil Cholid Atsani | RPL 1 Telkom Lampung | 2026</marquee>
